...
public class GUIClientCreate extends Application {
    ...
    UsuarioManager usuarios = UsuarioManager.getInstancia();
    ...
    public void start(Stage primaryStage) {
        ...
        btnSubmit.setOnAction(event -> {
            ...
            if (validatePhone(phone) && validateEmail(email)) {
                ...
                usuarios.agregar(newUser);  // Almacenar el usuario en UsuarioManager
                lblResult.setText("Se ha creado un nuevo cliente en el sistema, los datos del cliente son:\n"
