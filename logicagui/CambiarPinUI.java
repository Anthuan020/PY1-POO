...
public class CambiarPinUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        grid.getChildren().addAll(
                cuentaLabel, cuentaInput, pinActualLabel, pinActualInput, 
                nuevoPinLabel, nuevoPinInput, cambiarPinBtn, resultadoLabel
        );
        ...
        cambiarPinBtn.setOnAction(e -> {
            ...
            if (cuenta == null) {
                ...
                resultadoLabel.setText("PIN cambiado exitosamente.");
            }
        });
    }
